...
y_cols = [6, 7, 8, 9, 10, 11, 12]


create_plot(x_col=3, y_cols=y_cols, rows=[2, 17], x_label='Flow rate H$_2$ (m$_3$/h)', 
            y_label='output flow rate (%)', filename='plot_1', title='Plot 1', legend_outside=True)


create_plot(x_col=3, y_cols=y_cols, rows=[19, 34], x_label='Flow rate H$_2$ (m$_3$/h)', 
            y_label='output flow rate (%)', filename='plot_2', title='Plot 2', legend_outside=True)


create_plot(x_col=3, y_cols=y_cols, rows=[36, 51], x_label='Flow rate H$_2$ (m$_3$/h)', 
            y_label='output flow rate (%)', filename='plot_3', title='Plot 3', legend_outside=True)


create_plot(x_col=3, y_cols=y_cols, rows=[53, 68], x_label='Flow rate H$_2$ (m$_3$/h)', 
            y_label='output flow rate (%)', filename='plot_4', title='Plot 4', legend_outside=True)


create_plot(x_col=4, y_cols=y_cols, rows=[70, 88], x_label='Reactor Temperature (C)', 
            y_label='output flow rate (%)', filename='plot_6', title='Plot 6', legend_outside=True)


create_plot(x_col=0, y_cols=y_cols, rows=[90, 109], x_label='Reactor Pressure (bar)', 
            y_label='output flow rate (%)', filename='plot_7', title='Plot 7', legend_outside=True)


create_plot(x_col=0, y_cols=y_cols, rows=[111, 130], x_label='Reactor Pressure (bar)', 
            y_label='output flow rate (%)', filename='plot_8', title='Plot 8', legend_outside=True)


create_plot(x_col=0, y_cols=y_cols, rows=[132, 151], x_label='Reactor Pressure (bar)', 
            y_label='output flow rate (%)', filename='plot_9', title='Plot 9', legend_outside=True)


create_plot(x_col=0, y_cols=y_cols, rows=[153, 172], x_label='Reactor Pressure (bar)', 
            y_label='output flow rate (%)', filename='plot_10', title='Plot 10', legend_outside=True)


create_plot(x_col=2, y_cols=y_cols, rows=[174, 189], x_label='Flow rate CO & CO$_2$ (m$_3$/h)', 
            y_label='output flow rate (%)', filename='plot_11', title='Plot 11', legend_outside=True)


create_plot(x_col=2, y_cols=y_cols, rows=[191, 206], x_label='Flow rate CO & CO$_2$ (m$_3$/h)', 
            y_label='output flow rate (%)', filename='plot_12', title='Plot 12', legend_outside=True)


create_plot(x_col=2, y_cols=y_cols, rows=[208, 223], x_label='Flow rate CO & CO$_2$ (m$_3$/h)', 
            y_label='output flow rate (%)', filename='plot_13', title='Plot 13', legend_outside=True)


create_plot(x_col=2, y_cols=y_cols, rows=[225, 240], x_label='Flow rate CO & CO$_2$ (m$_3$/h)', 
            y_label='output flow rate (%)', filename='plot_14', title='Plot 14', legend_outside=True)
            

gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_1.png Figure_1.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_2.png Figure_2.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_3.png Figure_3.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_4.png Figure_4.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_5.png Figure_5.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_6.png Figure_6.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_7.png Figure_7.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_8.png Figure_8.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_9.png Figure_9.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_10.png Figure_10.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_11.png Figure_11.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_12.png Figure_12.eps
gs -sDEVICE=png16m -dEPSCrop -r600 -o Figure_13.png Figure_13.eps